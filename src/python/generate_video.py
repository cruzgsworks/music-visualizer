...
def main():
    ...
    log_progress(args.job_id, "log", None, "Starting video generation...")
    ...
    try:
        ...
        # Success output
        print(json.dumps({"type": "complete", "success": True, "jobId": args.job_id}))
        
    except Exception as e:
        print(json.dumps({"type": "complete", "success": False, "error": str(e), "jobId": args.job_id}))
        sys.exit(1)
